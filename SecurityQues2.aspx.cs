...
{
    public partial class SecurityQues2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from QPS_Recovery2", con);
        ...
        {
            Response.Redirect("~/SecurityQues.aspx");
        }

        protected void Submit_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/SecurityQues3.aspx");
        }
    }
}