<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityQues2.aspx.cs" Inherits="WebApplication2.SecurityQues2" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function validateSecurityQues2(event) {
            var current_Url = window.location.href;
            if (current_Url.includes("SecurityQues2")) {
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="col-6 cols1">
                ...
                <br />
                 <br />
                <asp:Button ID="Submit" runat="server" cssclass="btn px-5" Text="Next" onclientclick="return validateSecurityQues2()" OnClick="Submit_Click" />
            </div>
           <div class="container">
