<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="WebApplication2.AdminSignUp" %>
    ...
    <link href="StyleUp.css" rel="stylesheet" />
     ...
     <script type="text/javascript">
        ...
        function validateSignup(event) {
            ...
            if (current_Url.includes("AdminSignUp")) {
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="col-6 cols1">
                <h1>Sign Up - Admin</h1>
                <asp:TextBox ID="TextBox5" Placeholder="Employee ID" CssClass="form-control" runat="server"></asp:TextBox>
